...
public class Somatic {
	...
	{
        ArrayList<Double> read_lats = new ArrayList<Double>();
        ArrayList<Double> compute_lats = new ArrayList<Double>();
        Long cstart, cend, iostart, ioend;
        Double c_elapsed, io_elapsed;
